...
<div class="col-lg-8"  >
    <div class="page-header-title">
        <div class="d-inline" >
            <h4>OCCUPATIONAL SAFETY TRAINING </h4>
           <!--  <span>Report Occupational Health Management</span>
        </div> -->
    </div>
</div>
<!-- <div class="col-lg-4" >
...
<div id="wizard3">
    <form class="wizard-form" id="design-wizard" action="osha">
        <h3></h3>
           <%	Osha_Law osha=(Osha_Law)request.getAttribute("osha");
		  ...
		  %>
							...
							<br>
							<center><font size="5"><u><i><font color="TEAL" align="justify">OHSAS LAW</font></i></u></font></center>
							<br>
							<br>
							...
							<div class="col-sm-12">
									<div class="row">
										<div class="col-sm-12" align="center">
											...
											: </b> </font> </label><br> --> 
											<font size="4"><%=osha.getOsha_name()%></font>
										</div>
									</div>
								</div>
							</div>
							...
							<br><i><blackqoute><font size="2"><%=osha.getOsha_fact()%></font></blackqoute></i>
							</div>
							</div>
							<br>
							<br>
							...
							<label for="name-2" class="block"><font size="4"><b> OSHA LAW DESCRIPATION :</b></font></label>
							<br> <font size="3"><%=osha.getOsha_des() %></font>
							</div>
							</div>
							<br>
							<br>
							...
							<br> <font size="2"><%=osha.getOsha_date()%></font>
							</div>
							</div>
							<br>
							<br>
                ...
                <fieldset>
							...
							<%-- <div class="row text-center">
                              <div class="col-sm-12 invoice-btn-group text-center">
                                 <button rel="<%=contextPath %>/ehs/edit_osha_law" id="btn-edit" type="button" class="btn btn-danger m-b-10 btn-sm waves-effect waves-light m-r-20">Edit</button>
                              </div>
                          </div> --%>
</div>
</div>
