...
<div id="wizard3">
    ...
    <form class="wizard-form" id="inc-design-wizard" action="<%=contextPath%>/ehs/save_factory" method="post"  modelAttribute="factory">
    
    <input type=hidden class="form-control" id="opr_mode" name="opr_mode" value="${opr_mode}" />
	<input type=hidden class="form-control" id="industrial_id" name="industrial_id" value="${factory.factory_id}" />
	...
	<input type=hidden class="form-control" id="trans_id" name="ehs_Waste_Transport.trans_id" value="${waste.ehs_Waste_Transport.trans_id}" /> --%>
        ...
        <h3></h3>
                <fieldset>
								<legend>STANDARD FACTORY ACTS</legend>
								<div class="form-group row">
									<div class="col-sm-12">
										<div class="row">
											<div class="col-sm-6">
												<label for="name-2" class="block"><font size="3" ><b>Title:</b></font> </label> <input
													id="factory_name" name="factory_name" type="text"
													class="form-control">
											</div>
											<div class="col-sm-6">
												<label for="text-2" class="block"><font size="3" ><b>Fact</b> </font></label> <input
													id="factory_fact" name="factory_fact" type="text" class="form-control">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="form-group row">
									<div class="col-sm-12">
										<label for="text-2" class="block"><font size="3" ><b>Description:</b></font></label>
									</div>
									<div class="col-sm-12">
										<textarea rows="4" cols="50" id="factory_des" name="factory_des"
					 ...
					 -->				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
									<label for="emp_date" class="block"><font size="3" ><b>Date :</b></font></label>
									 ...
									 <div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4">
										<input id="factory_date" name="factory_date"
        ...
        onFinished: function(event, currentIndex) {
          alert("Submitted!");
            ...
            var form = new FormData($('#inc-design-wizard')[0]);
  			$.ajax({
                 url: '<%=contextPath%>/ehs/save_factory',
                 type: 'POST',
                 dataType :"json",
                 complete: function() {}, 
                 success:  function (data) {
                 	if(data.status == 1) {
                 		location.href='<%=contextPath%>/ehs/law_industrial_programs';
