							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10 " style="background-color:#f3f3f3">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	...
		                            	<button rel="<%=contextPath %>/ehs/new_waste" id="new_waste" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
					                            ...
					                            <table id="issue-list-table" class="table dt-responsive width-100">
													 <thead class="text-left">
													    ...
													    <tbody class="text-left">
						                                	<% 
						                                	List<Ehs_Waste> ehs_Waste =(List<Ehs_Waste>)request.getAttribute("waste_list");
						                                		if(ehs_Waste !=null&&!ehs_Waste.isEmpty()){
						                                			int idx_num=1;
						                                			for (Ehs_Waste waste : ehs_Waste ) {
						                                							                                			
						                                	%>
						                                	<tr>
					                                		 <td class="txt-primary"><%=idx_num++ %></td>
											                 <td><%=waste.getChem_name()%></td>
											                 <td><%=waste.getQuantity()%></td>
															  <td><%=waste.getWaste_department() %></td>
											                 <td><%=waste.getTechniques() %></td>
											                  <td><%=waste.getEhs_Waste_Transport().getDis_name() %></td>
											                  <td>
					                                        	 <button href="javscript:void(0);" rel="<%=contextPath %>/ehs/view_waste?waste_id=<%=waste.getWaste_id() %>" class="btn-sm btn-info btn-icon view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
	                                             	             <button href="jacvscript:void(0);" rel="<%=contextPath %>/ehs/edit_waste?waste_id=<%=waste.getWaste_id() %>" class="btn-sm btn-warning btn-icon edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
											                 </td>
