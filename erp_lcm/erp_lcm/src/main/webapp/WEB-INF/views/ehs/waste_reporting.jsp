...
<%
    ...
    String disposal_date=(String)request.getAttribute("disposal_date");
    String shipment_date=(String)request.getAttribute("shipment_date");
...
<div align="center">
		  <button rel="<%=contextPath %>/ehs/mng_waste_list" id="back" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Back</span></button>
...
<div id="wizard3">
    ...
    <form class="wizard-form" id="inc-design-wizard" action="<%=contextPath%>/ehs/save_ehs" method="post"  modelAttribute="waste">
    
    <input type=hidden class="form-control" id="opr_mode" name="opr_mode" value="${opr_mode}" />
	<input type=hidden class="form-control" id="waste_id" name="waste_id" value="${waste.waste_id}" />
<input type=hidden class="form-control" id="shipping_id" name="ehs_Shipping.shipping_id" value="${waste.ehs_Shipping.shipping_id}" />
	<input type=hidden class="form-control" id="trans_id" name="ehs_Waste_Transport.trans_id" value="${waste.ehs_Waste_Transport.trans_id}" />
        ...
        <h3><span>Waste Material Management</span></h3>
                <fieldset>
								<legend>A.Waste Material Management</legend>
								<div class="form-group row">
									<div class="col-sm-12">
										<div class="row">
											<div class="col-sm-12">
												<label for="name-2" class="block"><font size="4" >1.Material Name:</font> </label> <input
													id="chem_name" name="chem_name" type="text"
													class="form-control">
									 ...
									 <div class="row">
									   <div class="col-sm-12">
												<label for="text-2" class="block"><font size="4" >2.Quantity: </font></label> <input
									...
									<div class="form-group row">
									<div class="col-sm-12">
										<label for="text-2" class="block"><font size="4" >3.Description:</font></label>
										<textarea rows="4" cols="50" id="waste_desc" name="waste_desc"
													type="text" class=" form-control"></textarea>
								    	</div>
								   </div>
								   
					   <div class="row">
					    	<label class="col-sm-3"><font size="4" >4.Department:</font>
						   </label>
							 <div class="col-sm-3">
								...
								<!-- 	<div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
									<label for="emp_date" class="block"><font size="4" >Date of	Disposal</font></label>
									</div>
									 <div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4">
										<input id="disposal_date" name="disposal_date"
												type="text" class="form-control "
													placeholder="select your Treatment Date" />
									</div> -->
									
							<!-- 		<label class="col-sm-3"><font size="4" >Types of Techniques</font>
						   </label>
							 <div class="col-sm-3">
								<select type="text" class="form-control"
							...
							<div class="row">
								<div class="col-sm-3">
									<label for="emp_date" class="block"><font size="4" >5.Date of Disposal:</font></label>
									</div>
							...
							<div class="row">
								<label class="col-sm-3"><font size="4" >6.Disposal Method:</font>
							   </label>
							 <div class="col-sm-3">
								<select type="text" class="form-control"
										id="techniques" name="techniques"
  ...
  <!--   <div class="form-group row">
           ...
           <legend>B.Transportation: </legend>
           
           <div class="form-group row">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-12">
							<label for="name-2" class="block"><font size="4" >1.Vehicle Name:</font> </label> <input
								id="veh_name" name="ehs_Waste_Transport.veh_name" type="text"
								class="form-control">
					  </div>
					</div>
					 ...
					 <div class="row">
					   <div class="col-sm-12">
								<label for="text-2" class="block"><font size="4" >2.Vehicle Number: </font></label> <input
									id="veh_number" name="ehs_Waste_Transport.veh_number" type="text" class="form-control">
							</div>
					 </div>
					 
					 <div class="row">
					   <div class="col-sm-12">
						<label for="text-2" class="block"><font size="4" >3.Material Quantity:</font></label>
					 
				    
						   <input id="material_qty" name="ehs_Waste_Transport.material_qty"
									   type="text" class=" form-control">
				    	</div>
					 </div>
					 ...
					 <div class="row">
					    <div class="col-sm-12">
                   			 <label for="address-2" class="block"><font size="4" >4.Disposal Name:</font></label>
               			
                   		 <input id="dis_name" name="ehs_Waste_Transport.dis_name" type="text" class="form-control" value="MEPL Ranjangaon">
              			  </div>
					 </div><br>
					 
					 <div class="row">
					   <div class="col-sm-3col-sm-3">
							<label for="emp_date" class="block"><font size="4" >5.Date of Dispatch:</font></label>
							</div>
							 <div class="form-group col-sm-3">
            ...
            <!-- File upload card start -->
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <div class="sub-title"><font size="3" ><b>Document Name:</b></font></div>
													<input type="file" class="form-control" onchange="document.getElementById('doc_waste_view').src = window.URL.createObjectURL(this.files[0])" id="doc_waste_name" name="doc_waste_name" multiple="multiple">                                            </div>
                                        </div>
                                        <div>
                                        </div>
           <!--  <div class="form-group row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="name-2" class="block"><font size="4" >Vehicle Name:</font> </label>
                                <input id="shipping_name" name="ehs_Shipping.shipping_name" type="text" class="form-control">
                                    </div>
                        <div class="col-sm-6">
                            <label for="text-2" class="block"><font size="4" >Vehicle  Number:</font></label>
                    ...
                    <div class="row">
	                      <div class="col-sm-6">
	                            <label for="text-2" class="block"><font size="4" >Material Quantity:</font></label>
	                                <input id="waste_unit" name="ehs_Shipping.waste_unit" type="text" class="form-control">
                       		</div>
                    </div>            
                            </div>
            	...
            	<!-- <div class="form-group row">
					...
					<div class="col-sm-12">
						<input id="waste_desc" name="waste_desc"
									type="text" class=" form-control">
				    	</div>
			   </div>
			    -->
            <!-- <div class="form-group row">
                <div class="col-sm-12">
                    <label for="address-2" class="block"><font size="4" >Disposal Name:</font></label>
                </div>
                <div class="col-sm-12">
                    <input id="dis_address" name="ehs_Shipping.dis_address" type="text" class="form-control" value="MEPL Ranjangaon">
                </div>
            </div> -->
        ...
        onFinished: function(event, currentIndex) {
          alert("Submitted!");
            ...
            var form = new FormData($('#inc-design-wizard')[0]);
  			$.ajax({
                 url: '<%=contextPath%>/ehs/save_waste',
                 type: 'POST',
                 dataType :"json",
                 complete: function() {}, 
                 success:  function (data) {
                 	if(data.status == 1) {
                 		location.href='<%=contextPath%>/ehs/mng_waste_list';
	...
	%>	
		<script type="text/javascript">
			$(document).ready(function() {
		    		...
		    		$('#disposal_date').val('${disposal_date}');
			        ...
			        $('#veh_name').val('<%=waste.getEhs_Waste_Transport().getVeh_name()%>');
			     	$('#veh_number').val('<%=waste.getEhs_Waste_Transport().getVeh_number()%>');
				 	$('#material_qty').val('<%=waste.getEhs_Waste_Transport().getMaterial_qty()%>');  
					$('#dis_name').val('<%=waste.getEhs_Waste_Transport().getDis_name()%>');
					$('#shipment_date').val('${shipment_date}');
		...
		<script type="text/javascript">
			$(document).ready(function() {
			 ...
			 --%>	
				...
				$('#veh_name').replaceWith($("<span>",{text:'<%=waste.getEhs_Waste_Transport().getVeh_name()%>'}));
				$('#veh_number').replaceWith($("<span>",{text:'<%=waste.getEhs_Waste_Transport().getVeh_number()%>'}));
				$('#material_qty').replaceWith($("<span>",{text:"<%=waste.getEhs_Waste_Transport().getMaterial_qty()%>"}));
				$('#dis_name').replaceWith($("<span>",{text:'<%=waste.getEhs_Waste_Transport().getDis_name()%>'}));
