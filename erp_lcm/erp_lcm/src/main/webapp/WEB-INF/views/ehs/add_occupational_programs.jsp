...
<div class="col-lg-8"  >
    <div class="page-header-title">
        <div class="d-inline" >
            <h4>OCCUPATIONAL HEALTH MANAGEMENT </h4>
...
<div class="col-md-12">
<div id="wizard3">
    <form class="wizard-form" id="design-wizard" action="training">
        <h3></h3>
           <%	Ehs_Training training=(Ehs_Training)request.getAttribute("training");
				String value=(String)request.getAttribute("value");

				if(value!=null&&training!=null){
				if(value.equals("impact")){
					
			
		  %>
							<br>
							<center><font size="5"><u><i><font color="TEAL">OSHA LAW</font></i></u></font></center>
							<br>
							<br>
