							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10" style="background-color:#f3f3f3">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	<button rel="<%=contextPath %>/danagrous_goods_mgt/new_danagrous_goods_magt" id="new_danagrous_goods_magt" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
													 ...
													 <thead class="text-left">
													    ...
													    <tbody class="text-left">
											                ...
											                <td class="center text-center">
											             		 <button href="javscript:void(0);" rel="<%=contextPath %>/ehs/impact_danagrous_goods?hazard_id=<%=chemical.getHazard_id()%>" class="btn-sm btn-info btn-icon view_item" data-toggle="tooltip" data-placement="top" title="Impact" ><i class="icofont icofont-eye-alt"></i></button>
                                             					 <button href="jacvscript:void(0);" rel="<%=contextPath %>/ehs/risk_danagrous_goods?hazard_id=<%=chemical.getHazard_id()%>" class="btn-sm btn-warning btn-icon edit_item" data-toggle="tooltip" data-placement="top" title="Risk Assessment"><i class="icofont icofont-edit"></i></button>
                                              					 <button href="javscript:void(0);" rel="<%=contextPath %>/ehs/safety_danagrous_goods?hazard_id=<%=chemical.getHazard_id()%>" class="btn-sm btn-info btn-icon view_item1" data-toggle="tooltip" data-placement="top" title="Safety" ><i class="icofont icofont-eye-alt"></i></button>
				                                          	</td> 
															</tr>
									                        <%} } else{ %>
									                        <tr>
...
<script>
		    ...
		    $(document).ready(function() {
		        ...
		        $('#new_danagrous_goods_magt').on('click', function() {
		           var loc=$(this).attr('rel');
		           $("#page_body").load(loc);
				});
