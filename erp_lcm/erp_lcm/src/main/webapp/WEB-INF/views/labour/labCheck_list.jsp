				...
				<div id="page_body">
								...
								<div class="card-block">
									...
									<div class="card-block p-t-10">
										<div class="input-group">
											<form id="search_lab" method="post" action="<%=contextPath%>/labour/mng_checkIn">
			                    				<div class="card-block p-t-10">
											...
											<div>
                               				...
                               				List<LabourCheck> check_list =(List<LabourCheck>)request.getAttribute("check_list");
                    					          	if(check_list!=null&&!check_list.isEmpty()){
                    					                    	int idx_num=1;
                    					                    	for (LabourCheck labourCheck1 :check_list) {
                    					                    	
                              						 	%>
																<tr>
																	<td class="txt-primary"><%=idx_num++%></td>
																	<%--     <td><%=labourService.getLabourByNameID(labourCheck)%><td> --%>
																	<td><%=labourCheck1.getLabour().getLab_fname()%>&nbsp;<%=labourCheck1.getLabour().getLab_mname()%>&nbsp;<%=labourCheck1.getLabour().getLab_lname()%></td>
																	<td><%=labourCheck1.getDepartment().getDt_department_name()%></td>
																	<td><%=labourCheck1.getCheck_in()%></td>
																	<td><%=labourCheck1.getCheck_out()%></td>
																	<td class="center text-center">
																		<button href="javscript:void(0);"
																			rel="<%=contextPath%>/labour/check_out?lab_check_id=<%=labourCheck1.getLab_check_id()%>"
																			class="btn btn-warning btn-mini b-none edit_item "
																			data-toggle="tooltip" data-placement="top"
																			title="Check_Out">Check Out</button>
																		<button href="javscript:void(0);"
																			rel="<%=contextPath%>/labour/salary?lab_id=<%=labourCheck1.getLabour().getLab_id()%>"
                    ...
                    <div class="card card-border-primary">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list list-unstyled">
                                        <li>Labour Name: &nbsp;<%=labourCheck1.getLabour().getLab_fname()%>&nbsp;<%=labourCheck.getLabour().getLab_mname()%>&nbsp;<%=labourCheck.getLabour().getLab_lname()%></li>
                                        <li>Department: <span class="text-semibold"><%=labourCheck1.getDepartment().getDept_id()%></span></li>
                                       <li>Check In: <span class="text-semibold"><%=labourCheck1.getCheck_in() %></span></li>
                                        <li>Check out: <span class="text-semibold"><%=labourCheck1.getCheck_out() %></span></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="card-footer">
						         <button href="javscript:void(0);" rel="<%=contextPath%>/labour/check_out?lab_check_id=<%=labourCheck1.getLab_check_id()%>" class="btn btn-warning btn-mini b-none edit_item " data-toggle="tooltip" data-placement="top" title="Check_Out">Check Out</button>
								<button href="javscript:void(0);" rel="<%=contextPath%>/labour/salary?lab_check_id=<%=labourCheck1.getLab_check_id()%>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="Salary">Salary</button>
