							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	<button rel="<%=contextPath%>/labour/new_contract" id="new_contract" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
		                            	<div class="btn-group m-b-5 m-t-5">
			                               <!--  <button type="button" class="btn btn-primary btn-sm waves-effect waves-light"><i class="icofont icofont-ui-user"></i></button>
			                                ...
			                                <button type="button" id="import_contractor" class="btn btn-primary btn-sm waves-effect waves-light"><i class="icofont icofont-file-excel"></i> Import Contractor</button>
		                                </div>
		                                <div class="btn-group m-b-5 m-t-5">
                                	<button  id="export_con" href="javscript:void(0);" rel="<%=contextPath %>/labour/export_contractor" class="btn btn-primary btn-sm waves-effect waves-light"><i class="icofont icofont-file-excel"></i>Export Contractor</button>
                               	 </div>
		                    		</div>
					                    ...
					                    <div class="card-block">
					                        <div class="table-responsive">
					                            <table id="issue-list-table" class="table dt-responsive width-100">
				                                	...
				                                	<%
				                                		List<Contractor> ctr_list =(List<Contractor>)request.getAttribute("ctr_list");
                         					          	if(ctr_list!=null&&!ctr_list.isEmpty()){
                         					                    	int idx_num=1;
                         					                    	for (Contractor ctr :ctr_list) {
				                                	%>
					                                		<tr>
					                                		 <td class="txt-primary"><%=idx_num++%></td>
											              
											                 <td><%=ctr.getCd_code()%></td>
											                 <td><%=labourService.getContractorByFullName(ctr)%></td>
											                <td><%=ctr.getCd_join_date()%>
											                </td>
<%-- 											                 <td><%=labourService.getContractorMaritalStatus(ctr)%></td>									                
 --%>											                 <td class="center text-center">
															 	<button href="javscript:void(0);" rel="<%=contextPath%>/labour/view_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   				<button href="javscript:void(0);" rel="<%=contextPath%>/labour/edit_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  				<button href="javscript:void(0);" rel="<%=contextPath%>/labour/delete_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
                                                  				 <button href="javscript:void(0);" rel="<%=contextPath%>/labour/view_con_labour?cd_id=<%=ctr.getCd_id()%>" class="btn btn-success btn-mini b-none alert-confirm view_lab_item" data-toggle="tooltip" data-placement="top" title="View Labour List"><i class="icofont icofont-users-social"></i></button> 
						                ...
						                <div class="col-sm-6">
						                    <div class="card card-border-primary">
						                        ...
						                        <div class="card-block">
						                            <div class="col-sm-12">
							                            <div class="row">
						                                    <div class="col-sm-4">Labour Code:  </div><div class="col-sm-8"><%=ctr.getCd_code() %></div>
						                                   <%-- <div class="col-sm-3">Title:</div><div class="col-sm-9"><%=labour.getJp_department() %></div>--%>
					                                    	<div class="col-sm-4">Full Name:</div><div class="col-sm-8"><%=labourService.getContractorByFullName(ctr) %></div>
					                                     	<div class="col-sm-4">Gender:</div><div class="col-sm-8"><%=labourService.getContractorGender(ctr)%></div>
						                                    <div class="col-sm-4">Date of Birth:</div><div class="col-sm-8"><%=ctr.getCd_dob() %></div>
						                                    <div class="col-sm-4">Marital status:</div><div class="col-sm-8"><%=labourService.getContractorMaritalStatus(ctr) %></div>
						                                </div>
						                        ...
						                        <div class="card-footer">
						                            ...
						                            <div class="task-board m-0">
						                                <button href="javscript:void(0);" rel="<%=contextPath%>/labour/view_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   		<button href="javscript:void(0);" rel="<%=contextPath%>/labour/edit_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  		<button href="javscript:void(0);" rel="<%=contextPath%>/labour/delete_contract?cd_id=<%=ctr.getCd_id()%>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
														 <button href="javscript:void(0);" rel="<%=contextPath%>/labour/view_con_labour?cd_id=<%=ctr.getCd_id()%>" class="btn btn-success btn-mini b-none alert-confirm view_lab_item" data-toggle="tooltip" data-placement="top" title="View Labour List"><i class="icofont icofont-archive"></i></button>
...
<div class="modal fade show" id="import_file" tabindex="-1" role="dialog" style="z-index: 1050; display: none;">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <form method="POST" action="${pageContext.request.contextPath}/labour/import_contractor"
					enctype="multipart/form-data">
	              <div class="modal-body">
	                  <h5>Import new contractor by excel sheet</h5>
...
<script>
		    ...
		    $(document).ready(function() {
		        ...
		        $('#import_contractor').on('click',function(){
		        	var loc=$(this).attr('rel');
		        	$('#import_file').modal();
		    	});
		        
		        //script to export contractor file
	        	$('#export_con').on('click',function(){
	        	var loc=$(this).attr('rel');
	        	location.href=loc;
	        	 });
		        ...
		        $('.remove_item').on('click',function(){
		            ...
		            swal({
		                 title: "Are you sure?",
		                 text: "You will not be able to recover this Contractor information!",
		                 type: "warning",
		                 ...
		                 $.ajax({
		                     ...
		                     success: function (data) {
		                    	 if (data=='true') {
		                     		...
		                     		swal("Deleted!", "Contractor has been deleted.", "success");
								 } 
		                     },
		        ...
		        $('.view_lab_item').on('click', function() {
		            var loc=$(this).attr('rel');
		            location.href=loc;
		 		});
