<%@page import="com.spcl.erp.services.ScrapService"%>
...
ScrapService scrapService=(ScrapService)request.getAttribute("scrapService");
...
<nav class="navbar navbar-light bg-faded m-b-30 p-10">
    <div class="card-block">
    	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
        	<button rel="<%=contextPath %>/scrap/new_scrap" id="new_scrap" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
                        ...
                        <table id="issue-list-table" class="table dt-responsive width-100">
                        	...
                        	<tbody class="text-left">
                        		...
                        		<tr>
	                                ...
	                                <td><%=scrap.getScrap_pro_id() %></td>
	                                <td><%=scrap.getScrap_pro_qty() %></td>
	                                <td><%=scrap.getScrap_document()%></td>
	                               
							        <td class="center text-center">
										<button href="javscript:void(0);" rel="<%=contextPath %>/scrap/view_scrap?scrap_id=<%=scrap.getScrap_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                           				<button href="javscript:void(0);" rel="<%=contextPath %>/scrap/edit_scrap?scrap_id=<%=scrap.getScrap_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                          				<button href="javscript:void(0);" rel="<%=contextPath %>/scrap/delete_scrap?scrap_id=<%=scrap.getScrap_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
                                  	</td>
    	...
    	%><!-- Invoice list card start -->
                <div class="col-sm-6">
                    <div class="card card-border-primary">
                        <div class="card-header">
                            <h5><%=scrap.getScrap_pro_id() %></h5>
                        </div>
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list list-unstyled">
                                        <li>Quantity: &nbsp;<%=scrap.getScrap_pro_qty() %></li>
                                        <li>Document: <span class="text-semibold"><%=scrap.getScrap_document()%></span></li>
                                        <li>Created By: <span class="text-semibold"><%=scrap.getScrap_created_by()%></span></li>
