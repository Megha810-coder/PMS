...
<nav class="navbar navbar-light bg-faded m-b-30 p-10">
    <div class="card-block">
    	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
        	<button rel="<%=contextPath %>/marketing/new_contact" id="create_transfer" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
                    ...
                    <div class="table-responsive">
                        <table id="issue-list-table" class="table dt-responsive width-100">
                        	...
                        	<tbody class="text-left">
                            	<% 
                            		List<Contact> contactList=(List<Contact>)request.getAttribute("contact_list");
                        		...
                        		<tr>
	                                ...
	                                <td><%=contact.getCntc_name()%></td>
	                                <td><%=contact.getCntc_email() %></td>
	                                <td><%=contact.getCntc_mobile() %></td>
	                                <td><%=contact.getCntc_postion() %></td>
							        <td class="center text-center">
										<button href="javscript:void(0);" rel="<%=contextPath %>/marketing/view_contact?cntc_id=<%=contact.getCntc_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                           				<button href="javscript:void(0);" rel="<%=contextPath %>/marketing/edit_contact?cntc_id=<%=contact.getCntc_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                          				<button href="javscript:void(0);" rel="<%=contextPath %>/marketing/delete_contact?cntc_id=<%=contact.getCntc_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
                                  	</td>
                                  	 <td><%=contact.getCntc_address() %></td>
    	...
    	<!-- Invoice list card start -->
                <div class="col-sm-6">
                    <div class="card card-border-primary">
                        <div class="card-header">
                            <h5><%=contact.getCntc_name() %></h5>
                        </div>
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list list-unstyled">
                                        <li>Email-id: &nbsp;<%=contact.getCntc_email() %></li>
                                        <li>Contact: <span class="text-semibold"><%=contact.getCntc_mobile() %></span></li>
                                        <li>Job Role: <span class="text-semibold"><%=contact.getCntc_postion() %></span></li>
