							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	<button rel="<%=contextPath %>/hr_requirement/new_hr_requirement" id="new_hr_requirement" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
					                            ...
					                            <table id="issue-list-table" class="table dt-responsive width-100">
													 <thead class="text-left">
													    ...
													    <tbody class="text-left">
						                                	<% 
						                                	List<HrRequirement> hr_requirement_list=(List<HrRequirement>)request.getAttribute("hr_requirement_list");
						                                		if(hr_requirement_list!=null&&!hr_requirement_list.isEmpty()){
						                                			int idx_num=1;
						                                			for (HrRequirement hrrequirement : hr_requirement_list) {
						                                							                                			
						                                	%>
					                                		<tr>
					                                		 <td class="txt-primary"><%=idx_num++ %></td>
											              
											                 <td><%=hrrequirement.getHr_department() %></td>
											                 <td><%=hrrequirement.getHr_shifts()%></td>
											                 <td><%=hrrequirement.getLabour_required()%></td>
											                
											                 <td>
																 <button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/view_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   				<button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/edit_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  				<button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/delete_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
				                                          	 </td>
						                ...
						                <div class="col-sm-6">
						                    <div class="card card-border-primary">
						                        ...
						                        <div class="card-block">
						                            <div class="col-sm-12">
							                            <div class="row">
						                                    <div class="col-sm-3">Department:  </div><div class="col-sm-9"><%=hrrequirement.getHr_department() %></div>
						                                    <div class="col-sm-3">Shifts:</div><div class="col-sm-9"><%=hrrequirement.getHr_shifts() %></div>
						                                    <div class="col-sm-3">Labour Required:</div><div class="col-sm-9"><%=hrrequirement.getLabour_required() %></div>
						                                </div>
						                            </div> 
						                        </div>
						                        <div class="card-footer">
						                            ...
						                            <div class="task-board m-0">
						                                 <button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/view_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   		<button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/edit_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  		<button href="javscript:void(0);" rel="<%=contextPath %>/hr_requirement/delete_hr_requirement?hr_req_id=<%=hrrequirement.getHr_req_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button></div>
...
<script>
		    ...
		    $(document).ready(function() {
		        ...
		        $('#new_hr_requirement').on('click', function() {
		           var loc=$(this).attr('rel');
		           $("#page_body").load(loc);
				});
