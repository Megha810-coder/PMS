							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	<button rel="<%=contextPath %>/customer/new_customer" id="new_customer" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
					                            ...
					                            <table id="issue-list-table" class="table dt-responsive width-100">
													 <thead class="text-left">
													    ...
													    <tbody class="text-left">
						                                	<% 
						                                	List<Customer> customer_List=(List<Customer>)request.getAttribute("CUSTOMERLIST");
					                                		...
					                                		<tr>
											                 ...
											                 <td><%=customerService.getCustomerByFullName(customer) %></td>
											                 <td><%=customer.getCust_phone() %></td>
											                 <td><%=customer.getCust_email()%></td>
											                 <td><%=customer.getCust_gst_no()%></td>
											                 <td><%=customer.getEnq_city().getCity_name()%></td>
											                 
											                 <td class="center text-center">
																<button href="javscript:void(0);" rel="<%=contextPath %>/customer/view_customer?cust_id=<%=customer.getCust_id() %>" class="btn-sm btn-info btn-icon view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
				                                             	<button href="jacvscript:void(0);" rel="<%=contextPath %>/customer/edit_customer?cust_id=<%=customer.getCust_id() %>" class="btn-sm btn-warning btn-icon edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
				                                             	<button href="javscript:void(0);" rel="<%=contextPath %>/customer/delete_customer?cust_id=<%=customer.getCust_id() %>" class="btn-sm btn-danger btn-icon alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
				                                              	
				                                          	 </td>
				                                                  	
				                                        	 <td><%=customer.getCust_description()%></td>
						                ...
						                <div class="col-sm-6">
						                    <div class="card card-border-primary">
						                        ...
						                        <div class="card-block">
						                            <div class="col-sm-12">
							                            <div class="row">
						                                    <div class="col-sm-3">Phone No.: &nbsp </div><div class="col-sm-9"><%=customer.getCust_phone() %></div>
						                                    <div class="col-sm-3">Email Id:</div><div class="col-sm-9"><%=customer.getCust_email() %></div>
						                                    <div class="col-sm-3">Phone No.:</div><div class="col-sm-9"><%=customer.getCust_phone() %></div>
					                                        <div class="col-sm-3">GST No.:</div><div class="col-sm-9"><%=customer.getCust_gst_no() %></div>
