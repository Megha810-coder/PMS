							...
							<nav class="navbar navbar-light bg-faded m-b-30 p-10">
						        <div class="card-block">
		                        	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
		                            	<button rel="<%=contextPath%>/employee/new_employee_details" id="new_employee_details" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
					                            ...
					                            <table id="issue-list-table" class="table dt-responsive width-100">
				                                	...
				                                	%>
					                                		<tr>
											                 ...
											                 <td><%=employeeService.getEmployeeByFullName(employee)%></td>
											                 <td><%=employeeService.getEmployeeGender(employee)%></td>
											                 <td><%=employee.getEmp_dob()%></td>
											                 <td><%=employeeService.getEmployeeMaritalStatus(employee)%></td>									                
											                 <td class="center text-center">
															 	<button href="javscript:void(0);" rel="<%=contextPath%>/employee/view_employee?emp_id=<%=employee.getEmp_id()%>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   				<button href="javscript:void(0);" rel="<%=contextPath%>/employee/edit_employee?emp_id=<%=employee.getEmp_id()%>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  				<button href="javscript:void(0);" rel="<%=contextPath%>/employee/delete_employee?emp_id=<%=employee.getEmp_id()%>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
				                                          	 </td>
						                ...
						                <div class="col-sm-6">
						                    <div class="card card-border-primary">
						                        ...
						                        <div class="card-block">
						                            <div class="col-sm-12">
							                            <div class="row">
						                                    <div class="col-sm-4">Employee Code:  </div><div class="col-sm-8"><%=employee.getEmp_code() %></div>
						                                   <%-- <div class="col-sm-3">Title:</div><div class="col-sm-9"><%=employee.getJp_department() %></div>--%>
					                                    	<div class="col-sm-4">Full Name:</div><div class="col-sm-8"><%=employeeService.getEmployeeByFullName(employee) %></div>
					                                     	<div class="col-sm-4">Gender:</div><div class="col-sm-8"><%=employeeService.getEmployeeGender(employee) %></div>
						                                    <div class="col-sm-4">Date of Birth:</div><div class="col-sm-8"><%=employee.getEmp_dob() %></div>
						                                    <div class="col-sm-4">Marital status:</div><div class="col-sm-8"><%=employeeService.getEmployeeMaritalStatus(employee) %></div>
						                                </div>
						                        ...
						                        <div class="card-footer">
						                            ...
						                            <div class="task-board m-0">
						                                 <button href="javscript:void(0);" rel="<%=contextPath %>/employee/view_employee_type?emp_id=<%=employee.getEmp_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                                                   		<button href="javscript:void(0);" rel="<%=contextPath %>/employee/edit_employee_type?emp_id=<%=employee.getEmp_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                                                  		<button href="javscript:void(0);" rel="<%=contextPath %>/employee/delete_employee_type?emp_id=<%=employee.getEmp_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button></div>
...
<script>
		    ...
		    $(document).ready(function() {
		        ...
		        $('#new_employee_details').on('click', function() {
		           var loc=$(this).attr('rel');
		           $("#page_body").load(loc);
				});
