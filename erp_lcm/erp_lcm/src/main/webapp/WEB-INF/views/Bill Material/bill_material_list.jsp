<%@page import="com.spcl.erp.services.BillService"%>
<%@page import="com.spcl.erp.model.Bill"%>
...
BillService billService=(BillService)request.getAttribute("billService");
...
<nav class="navbar navbar-light bg-faded m-b-30 p-10">
    <div class="card-block">
    	<div class=" waves-effect waves-light m-r-10 v-middle issue-btn-group">
        	<button rel="<%=contextPath %>/bill/new_bill" id="new_bill" type="button" class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5"><i class="icofont icofont-paper-plane"></i><span class="m-l-10">Create</span></button>
                    ...
                    <div class="table-responsive">
                        <table id="issue-list-table" class="table dt-responsive width-100">
                        	...
                        	<tbody class="text-left">
                            	<% 
                            	List<Bill> bill_list=(List<Bill>)request.getAttribute("bill_list");
                        		...
                        		<tr>
	                                ...
	                                <td><%=bill.getBom_pro_id() %></td>
	                                 <td><%=bill.getBom_qty()%></td>
	                                <td><%=bill.getBom_create_by() %></td>
	                               
	                               
							        <td class="center text-center">
										<button href="javscript:void(0);" rel="<%=contextPath %>/bill/view_bill?bom_id=<%=bill.getBom_id() %>" class="btn btn-info btn-mini b-none view_item" data-toggle="tooltip" data-placement="top" title="View" ><i class="icofont icofont-eye-alt"></i></button>
                           				<button href="javscript:void(0);" rel="<%=contextPath %>/bill/edit_bill?bom_id=<%=bill.getBom_id() %>" class="btn btn-warning btn-mini b-none edit_item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icofont icofont-edit"></i></button>
                          				<button href="javscript:void(0);" rel="<%=contextPath %>/bill/delete_bill?bom_id=<%=bill.getBom_id() %>" class="btn btn-danger btn-mini b-none alert-confirm remove_item" data-toggle="tooltip" data-placement="top" title="Delete/Remove"><i class="icofont icofont-archive"></i></button>
                                  	</td>
    	...
    	%><!-- Invoice list card start -->
                <div class="col-sm-6">
                    <div class="card card-border-primary">
                        <div class="card-header">
                            <h5><%=bill.getBom_id() %></h5>
                        </div>
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list list-unstyled">
                                        <li>Product Name: &nbsp;<%=bill.getBom_qty() %></li>
                                        <li>Created By: <span class="text-semibold"><%=bill.getBom_create_by()%></span></li>
